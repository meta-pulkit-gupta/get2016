...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements com.service.ConverterService {
    ...
    private java.lang.String Converter_address = "http://localhost:8080/TemperatureConverter/services/Converter";
    ...
    public com.service.Converter getConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.service.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.ConverterSoapBindingStub _stub = new com.service.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.ConverterSoapBindingStub _stub = new com.service.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "Converter"));
        }
