...
/**
 * Helper class to query the database and wrapping the data.
 */
import java.sql.*;
...
public class Helper {
	...
	/**
	 * fetch title detail published by the author.
	 * 
	 * @param authorName
	 *            Author name
	 * @return List of titles published by author
	 */
	public static List<Titles> fetchTitlePublishedByAuthor(String authorName) {
		...
		try {
			...
			while (res.next()) {
				// wrap the data into title object
	...
	/**
	 * Delete those books which have not been issued since last 1 year.
	 * 
	 * @return how many tuples deleted.
	 */
	...
	/**
	 * Books issued or not by the given title name.
	 * 
	 * @param title
	 *            given by the user.
	 * @return true or false whether book issued or not.
	 */
